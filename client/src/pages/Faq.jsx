              ...
              <div className="accordion shadow" id="accordionExample">
                ...
                <div className="accordion-item">
                  ...
                  <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div className="accordion-body">
                    Our operating hours vary by location, but generally, we are open seven days a week from 15:45 to 1:00. You can find the specific hours for your nearest location on our website.
                    </div>
                  </div>
                </div>
                <div className="accordion-item">
